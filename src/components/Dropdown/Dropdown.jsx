            ...
            { isShown &&
                <div className="z-30 absolute bottom--1 w-max rounded-lg shadow-lg">
                    <div className="py-1 px-4 divide-y divide-mytheme-shell w-max rounded-lg bg-white" role="none">
                        <a href="https://wa.me/+6590529042" className="font-medium text-mytheme-charcoal flex items-center py-2 text-sm bg-white hover:bg-gray-100" role="menuitem" tabIndex="-1" id="menu-item-0">
                            ...
                            {"+65 9052 9042"}</a>
                        <a href="mailto:tanlisarah@gmail.com" className="font-medium text-mytheme-charcoal flex items-center py-2 text-sm bg-white hover:bg-gray-100" role="menuitem" tabIndex="-1" id="menu-item-1">
                            ...
                            <div className="px-1"></div>
                            {"Email"}</a>
                        <a href="https://www.linkedin.com/in/sarahtanli/" className="font-medium text-mytheme-charcoal flex items-center py-2 text-sm bg-white hover:bg-gray-100" role="menuitem" tabIndex="-1" id="menu-item-2">
                            <svg className="w-4 fill-mytheme-ebony" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
