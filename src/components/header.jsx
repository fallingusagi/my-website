...
export default function Header() {
    ...
    return (
        <div
            ...
            <button 
                className="p-2 rounded inline-flex relative w-max justify-center group hover:bg-mytheme-shell" 
                onClick={() => setIsShown(!isShown)} 
                id="Let's chat" aria-expanded="true" aria-haspopup="true">
                <p className='font-medium text-mytheme-charcoal group-hover:text-gray-900'>{"🤙 Let's chat!"}</p>
            </button>
            {isShown &&
                <div className="z-30 absolute top-0 w-max rounded-lg shadow-lg">
