...
import ProjectCharter from "../assets/ProjectCharter.png";
      ...
      <div className="px-12 sm:px-24 xl:px-40 pt-8 pb-24 space-y-4 sm:space-y-8 justify-center w-full...">
        <div className="grid grid-cols-1 place-self-center w-full...">
          <div className="relative h-80 w-80 place-self-center">
            <img
              className="h-80 place-self-center fill-gray-800"
              src={helloFace}
            />
          ...
          <div className="pb-8 space-y-4 sm:space-y-8 place-self-center">
            <div className="space-y-0 sm:space-y-2">
              <p className=" font-bold text-center text-3xl sm:text-5xl text-mytheme-charcoal">
                {"Hola! I'm Sarah,"}
              </p>
              <p className=" font-semibold text-center text-lg sm:text-2xl text-mytheme-charcoal">
                {"interface and experience designer"}
              </p>
            </div>
            <div className="justify-center">
              <p className="max-w-screen-sm text-center text-sm sm:text-lg text-mytheme-charcoal">
                {
                  "Humanising products and processes through researching, defining parameters, and synthesising solutions"
                }
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12 flex items-stretch">
          <Card
            ...
            pageLink={"/projectFR"}
            award={true}
            awardName={"SG Mark + G Mark 2021"}
            title={"Facilities Reporting Tool"}
            body={"Helping employees get things fixed"}
          />
          <Card
            imageSrc={ProjectAlise}
            pageLink={"/projectAlise"}
            title={"alise"}
            body={"Shop until you (don't) drop"}
          />
          <Card
            imageSrc={ProjectPayments}
            pageLink={"/projectPayments"}
            title={"More than a Payments app"}
            body={"Making everyday payments more engaging"}
          />
          <Card
            imageSrc={ProjectCC}
            award={false}
            ...
            body={"Empowering Relationship Managers to serve 600+ clients"}
          />
          <Card
            imageSrc={ProjectGYC}
            pageLink={"/projectGYC"}
            title={"Global Youth Conference"}
            body={"Branding an international sociocultural youth conference"}
          />
          <Card
            imageSrc={ProjectOC}
            pageLink={"/projectOC"}
            title={"One Community"}
            body={"Creating visuals with clear messages"}
          />
          <Card
            imageSrc={ProjectCharter}
            pageLink={"/projectCharter"}
            title={"Misc Projects"}
            body={
              "Branding a space-tech company that takes us to space sustainably, and more!"
            }
          />
        </div>
      </div>
